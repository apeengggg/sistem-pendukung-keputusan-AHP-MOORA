            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <!-- <p>AHP (Analytical Hierarchy Process) adalah prosedur yang berbasis matematis yang sangat baik dan sesuai untuk kondisi evaluasi atribut-atribut kualitatif. Atribut-atribut tersebut secara matematik dikuantiatisasi dalam satu set perbandingan berpasangan. Kelebihan AHP dibandingkan dengan yang lainnya karena adanya struktur yang berhirarki, sebagai konsekuensi dari kriteria yang dipilih, sampai kepada sub-sub kriteria yang paling mendetail. Memperhitungkan validitas sampai dengan batas toleransi inkonsistensi berbagai kriteria dan alternatif yang dipilih oleh pengambil keputusan.</p> -->

                  <!-- <p>Pada hakikatnya AHP merupakan suatu model pengambil keputusan yang komprehensif dengan memperhitungkan hal-hal yang bersifat kualitatif dan kuantitatif. dalammodel pengambilan keputusan dengan AHP pada dasarnya berusaha menutupi semua kekurangan dari model-model sebelumnya. Dengan AHP juga memungkinkan untuk mengukur dan mengatur dampak dari suatu komponen yang saling berinteraksi dalam suatu sistem terhadap kesalahan sistem (Saaty,2001)</p>

                  <p>Perangkat utama dari model ini adalah sebuah hirarki fungsional dengan input utamanya adalah persepsi manusia. Jadi perbedaan yang mencolok model AHP dengan model lainnya terletak pada jenis inputnya.</p> -->
                </div>
              </div>
            </div>
            <div class="col">
